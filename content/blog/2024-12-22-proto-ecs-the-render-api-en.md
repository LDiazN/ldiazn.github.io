...
thumbnail: /assets/images/proto-ecs/proto-ecs-first-render.gif
...
You can find more details about proto-ecs [here]({{< ref "blog/2024-01-05-proto-ecs-intro-en" >}}). 
...
> More about **Datagroups, Global Systems, and Local Systems** [here]({{< ref "blog/2024-01-05-proto-ecs-intro-en" >}}) 
...
All macaw types are just structs of floats. The handles are all very similar to [the ones described in this post]({{< ref "blog/2024-05-13-proto-ecs-memory-allocation-en" >}}),
